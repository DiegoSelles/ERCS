...
interface IERC20 {
    ...
    //Devuelve la cantidad de tokens para una direccion dada.
    function balanceOf(address account) external view returns (uint256);

    //Devuelve el número de tokens que el spender podrá gastar en nombre del propietario
    function allowance(address owner, address spender) external view returns (uint256);

    //Devuelve un valor booleando resultado de la operación indicada
    function transfer(address recipient, uint256 amount) external returns (bool);

    //Devuelve un valor booleando resultado de la operación indicada
    function transfer_books(address sender, address recipient, uint256 amount) external returns (bool);
    ...
    //Evento emitido cuando los tokens pasen de un origen a un destion
    event Transfer(address indexed from, address indexed to, uint256 value);

    //Evento que se emite cuando hay una asignación con el metodo allowance
...
contract ERC20Basic is IERC20 {
    ...
    string public constant name = "ERC20Selles";
    string public constant symbol = "ERCS";
    ...
    function transfer_books(address sender, address receiver, uint256 numTokens) public override returns (bool) {
